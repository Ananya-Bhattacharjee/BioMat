...

        {
            try {
                for(int ii=1;ii<11;ii++)
                {
                    ...
                    FileWriter writer = new FileWriter("F:\\Dambe\\mammals\\scale2down\\"+ String.valueOf(ii)+"edited225.fasta");
                    ...
                    writer.close();
                    writer = new FileWriter("F:\\Dambe\\mammals\\scale2down\\"+ String.valueOf(ii)+"edited225.dis");
                    writer.write("37");
                    writer.close();
