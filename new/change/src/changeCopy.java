...

        {
            try {
                for(int ii=1;ii<11;ii++) {
                    ...
                    FileWriter writer = new FileWriter("F:\\Dambe\\mammals\\scale2up\\"+String.valueOf(ii)+"edited36.fasta");
                    ...
                    writer.close();
                    writer = new FileWriter("F:\\Dambe\\mammals\\scale2up\\"+ String.valueOf(ii)+"edited36.dis");
                    writer.write("37");
                    writer.close();
