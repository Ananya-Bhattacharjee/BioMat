...

        {
            try {
                for(int ii=1;ii<11;ii++) {
                    ...
                    FileWriter writer = new FileWriter("F:\\Dambe\\mammals\\scale2downlogdet\\"+ String.valueOf(ii)+"edited342.fasta");
                    ...
                    writer.close();
                    writer = new FileWriter("F:\\Dambe\\mammals\\scale2downlogdet\\"+ String.valueOf(ii)+"edited342.dis");
                    writer.write("37");
                    writer.close();
