...
for word in read_words(r'F:\Dambe\test\carnivores\realDisEdit33.dis'):
    if(is_number(word)):
        if(i==0):
            continue
        #print((word))
...
complete_encoded = imputer.train(train_epochs=10000, batch_size=10)

printed = ""
i = 0
j = 0

f = open(r'F:\Dambe\test\carnivores\encoderEdited33forDambe.dis', "w+")
