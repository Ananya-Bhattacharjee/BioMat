...
ff= open(r'F:\Dambe\NewAverages\Baculovirus\missing12\encoderAll.dis', "a+")
...
for ii in range(0,10):
    ...
    for word in read_words(r'F:\Dambe\NewAverages\Baculovirus\missing12\missing4'+str(ii)+'.dis'):
        if(is_number(word)):
            if(i==0):
                continue
            #print((word))
    ...
    f = open(r'F:\Dambe\NewAverages\Baculovirus\missing12\missing4'+str(ii)+'encoder.dis', "w+")
    list=["AcMNPV",
        "BmNPV",
        "OpMNPV",
        "LdMNPV",
